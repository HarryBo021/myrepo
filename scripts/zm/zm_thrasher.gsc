...
function main()
{
	...
	zm_ai_thrasher::enable_thrasher_rounds();
	// level.var_3013498 = 2;
...
{
	wait 30;
	iPrintLnBold( "SPAWN THRASHER" );
	ai_thrasher = zm_ai_thrasher::spawn_thrasher(0);
	// level.thrasher_spawners = GetEntArray("zombie_thrasher_spawner", "script_noteworthy");
	// var_e3372b59 = zombie_utility::spawn_zombie(level.thrasher_spawners[0], "thrasher");
}
