...
CoD.VultureAidWallbuyWaypointContainer = InheritFrom(LUI.UIElement)
CoD.VultureAidWallbuyWaypointContainer.new = function (HudRef, InstanceRef, waypointContainer, Event)
	...
	Widget:setClass(CoD.VultureAidWallbuyWaypointContainer)
	Widget.id = "VultureAidWallbuyWaypointContainer"
	...
	VultureIconGlow:setRGB( 0.15, 1.0, 1.0 )
