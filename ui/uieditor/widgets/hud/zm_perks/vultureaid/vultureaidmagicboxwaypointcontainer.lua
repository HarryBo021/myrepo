...
CoD.VultureAidMagicboxWaypointContainer = InheritFrom(LUI.UIElement)
CoD.VultureAidMagicboxWaypointContainer.new = function (HudRef, InstanceRef, waypointContainer, Event)
	...
	Widget:setClass(CoD.VultureAidMagicboxWaypointContainer)
	Widget.id = "VultureAidMagicboxWaypointContainer"
	...
	VultureIconGlow:setRGB( 0.082352, 1.0, 1.0 )
	...
	VultureIcon:setTopBottom(false, false, -15, 15)
