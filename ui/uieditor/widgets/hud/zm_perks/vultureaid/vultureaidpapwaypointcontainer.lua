...
CoD.VultureAidPapWaypointContainer = InheritFrom(LUI.UIElement)
CoD.VultureAidPapWaypointContainer.new = function (HudRef, InstanceRef, waypointContainer, Event)
	...
	Widget:setClass(CoD.VultureAidPapWaypointContainer)
	Widget.id = "VultureAidPapWaypointContainer"
